...
# кортеж - набор неизменяемых данных (tuple) (невозможно изменить)
#a = (1,2,3,4,5,6,6)
#print(a, type(a))
...
# set - набор упорядочных по возрастанию уникальных значений (неизменяют)
#a = {1,2,3,4,5,}
#print(a, type(a))

#list_1 = [1,2,3,4,4,4,4,4,6,6,6,6]
#print(set(list_1))
#{1,2,3,4} тип данных set
